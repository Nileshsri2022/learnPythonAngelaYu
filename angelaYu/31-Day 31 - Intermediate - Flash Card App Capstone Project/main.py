"""Day 31 capstone: Flash Card App (French → English).

Requires the course assets: images/card_front.png, images/card_back.png,
images/right.png, images/wrong.png and data/french_words.csv.
"""
